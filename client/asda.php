	...
	<body class="goto-here">
			...
			<div class="home-slider owl-carousel">
				<div class="slider-item" style="background-image: url(images/bg_1.jpg);">
					...
					<div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
						...
						<p><a href="#" class="btn btn-primary">Compra ya</a></p>
						</div>
		...
		<section class="ftco-section">
			<div class="container">
				<div class="row no-gutters ftco-services">
					<div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
						...
						<div class="media-body">
							<h3 class="heading">Envios gratuitos</h3>
				...
				<div class="media-body">
					<h3 class="heading">Siempres frescos</h3>
		...
		<div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
			<div class="media block-6 services mb-md-0 mb-4">
				...
				<div class="media-body">
					...
					<span>24horas, 7dias a la semana</span>
				</div>
			</div>
		</div>
		</div>
			...
			<div class="container">
				<div class="row justify-content-center mb-3 pb-3">
					<div class="col-md-12 heading-section text-center ftco-animate">
						<span class="subheading">Productos selectos</span>
			...
			<div class="row mb-5">
				...
				<div class="col-md">
					<div class="ftco-footer-widget mb-4">
						<h2 class="ftco-heading-2">DulceKat</h2>
					...
					<div class="ftco-footer-widget mb-4">
						...
						<ul>
							<li>
								...
								<span class="text">Plaza Villa Sur, puesto A-29. Villa el Salvador</span>
							</li>
							<li><a href="#">
